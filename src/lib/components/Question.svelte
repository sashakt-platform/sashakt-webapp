<script lang="ts">
	...
	import { pageStore, selectionStore } from '$lib/stores/store';
	...
	let selectedQuestions = $state<TSelection[]>(selectionStore.current);
</script>

<Pagination.Root
	count={totalQuestions}
	{perPage}
	page={pageStore.current}
	onPageChange={(val) => (pageStore.current = val)}
>
